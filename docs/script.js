...
(function () {
  ...
  function initActiveLink() {
    ...
    document.querySelectorAll('.sidebar-link').forEach(function (link) {
      ...
      if (href && (path === href || (href.endsWith('/index.html') && path === href.replace('index.html', '')))) {
  ...
  function highlightCode() {
    var keywords = /\b(const|let|var|function|return|if|else|for|while|import|export|from|default|class|interface|type|async|await|new|this|typeof|instanceof|void|delete|in|of|yield|switch|case|break|continue|do|try|catch|finally|throw|extends|implements|declare|namespace|module|enum|readonly|abstract|override|satisfies|as|keyof|infer|is)\b/g
    var builtins = /\b(console|document|window|process|require|module|exports|Promise|Array|Object|String|Number|Boolean|Map|Set|JSON|Math|Error|RegExp|Date|Symbol|Proxy|Reflect|URL|fetch|setTimeout|setInterval|clearTimeout|clearInterval)\b/g
