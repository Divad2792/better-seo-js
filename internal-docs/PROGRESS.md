...
| **🟨 Partial** | **7–12** | **7:** **C16** (`fromContent` / `fromMdxString`) in core; **C17** **`fromMdx`** in **`@better-seo/compiler`** (gray-matter + body via **`fromContent`**); not a full MDX AST compiler. **8 / 10:** **`snapshot`**, **`preview`**, **`analyze`**. **11:** **`ogPaletteFromTokens`**. **12:** **`@better-seo/crawl`** + CLI. **9:** TUI + **`doctor`**; **L9–L11** templates not shipped. |
...
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **7**  | **`@better-seo/core`**: **`fromContent`**, **`fromMdxString`** (**C16**); **`@better-seo/compiler`**: **`fromMdx`** (**C17**, **gray-matter** + **`fromContent`**); **`from-mdx.test.ts`**                                          | Full MDX AST / compile pipeline; extra PRD §3.9 “compiler” depth                                                          |
